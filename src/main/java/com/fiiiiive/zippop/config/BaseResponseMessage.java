...
public enum BaseResponseMessage {
    ...
    MEMBER_REGISTER_FAIL_PASSWORD_FORMAT(false, 2005, "패스워드 형식이 맞지 않습니다."),
    MEMBER_REGISTER_FAIL_PASSWORD_COMPLEXITY(false, 2006, "복잡한 패스워드를 사용해주세요"),
    MEMBER_REGISTER_FAIL_NAME_EMPTY(false, 2007, "이름을 입력해주세요"),
